...
pcpPars = struct('showFlag', [], 'grayFlag', [], 'saveFlag', [], ...
                 ...
                 'url', [], 'frameNoff', [], ...
                 'ghost', [], 'ghostFrames', [], 'ghostFactor', [], 'ghostUniModOff', [], ...
...
switch lower(dname)
  ...
  case{'default'}
    ...
    pcpPars = setDefault_binMask(pcpPars);
    pcpPars = setDefault_Thresh(pcpPars);
    ...
    pcpPars.ghost   = 0;
    pcpPars.ghostUniModOff = 0.1;
    pcpPars.ghostFactor = 10;
    pcpPars.ghostFrames = 0;
  ...
  case{'default_ghost'}
    ...
    pcpPars.ghost   = 1;
    pcpPars.ghostUniModOff = 0.1;
    pcpPars.ghostFrames = 20;
    pcpPars.ghostFactor = 0;
    pcpPars.ComputeBinaryMask = INCPCP_COMPUTE_BINMASK_1MOD;
...
function[pcpPars] = setDefault_Thresh(pcpPars)

    pcpPars.shrinkRule   = 'soft';
    pcpPars.shrinkAlpha  = 1.0;
    pcpPars.shrinkBeta   = 0.0;
...
incAMFastPCPdefs;
    ...
    pcpPars.sparseGTflag  = INCPCP_GT_NONE;
    
    pcpPars.GTBasedir     = [];         % directory 
    pcpPars.GTBasedirMat  = [];         % directory 
    pcpPars.GTmatrix      = [];         % matrix
    
return;

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function[pcpPars] = setDefault_binMask(pcpPars)

    pcpPars.ComputeBinaryMask = 0;
    pcpPars.binaryThresh = 0;
    pcpPars.binaryfIndex = [];
    pcpPars.binaryShowFlag = 0;    
    pcpPars.uniModOff = 0.1;
